...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="http://localhost/AnimeProject/home.php"  id="title">MyAnimeCompanion</a>
    </div>
    <h4>  <a href="http://localhost/AnimeProject/ProfileorLogin.php"  id="upper_right">Profile</a></h4>
  </div>
</nav>
...
<div id="slides" class="carousel slide" data-ride="carousel">
 ...
 <div class="scrollmenu">
   <a href="genre.php?id=Action">Action</a>
   <a href="genre.php?id=Comedy">Comedy</a>
   <a href="genre.php?id=Adventure">Adventure</a>
   <a href="genre.php?id=Romance">Romance</a>
   <a href="genre.php?id=Slice of Life">Slice of Life</a>
   <a href="genre.php?id=Thriller">Thriller</a>
   <a href="genre.php?id=Drama">Drama</a>
   <a href="genre.php?id=Sci-fi">Sci-fi</a>
   <a href="genre.php?id=Supernatural">Supernatural</a>
   ...
 </div>
<?php
	session_start();
          ...
          <div class="overlay">
           ...
           <input type="hidden" name="hidden_name" value="<?php echo $item["name"]; ?>"/>
            ...
            /*  header('Location:http://localhost/AnimeProject/details.php');  exit;*/
             echo '<script>window.location="http://localhost/AnimeProject/details.php"</script>';
            }?>
						</div>
